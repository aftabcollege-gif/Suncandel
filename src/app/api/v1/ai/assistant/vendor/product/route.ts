...
import { aiVendorProductCopilotSchema } from "@/API/schemas";
...
export async function POST(req: Request) {
  try {
    ...
    const body = await parseJson(req, aiVendorProductCopilotSchema);
    const data = await aiCommerceService.vendorProductCopilot({
